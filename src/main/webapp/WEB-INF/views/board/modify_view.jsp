...
<section>
    ...
    <form action="modify" name="modify" method="post" enctype="multipart/form-data">
      <table>
      ...
      <input type="hidden" name="fileName" value="${map.boardDto.fileName }">
        <colgroup>
          <col width="15%">
          <col width="85%">
        </colgroup>
        ...
        <tr>
          <th>제목</th>
          <td>
            <input type="text" name="btitle" value="${map.boardDto.btitle }">
          </td>
        </tr>
        <tr>
          <th>내용</th>
          <td>
            <textarea name="bcontent" cols="50" rows="10">${map.boardDto.bcontent }</textarea>
          </td>
        </tr>
        <tr>
          <th>이미지 표시</th>
          <td>
            ...
            <%-- 이렇게 주소를 쓰게되면 톰캣에 있는 upload인지11  --%>
            <img src="/upload/${map.boardDto.fileName }"/>
            <a href="/upload/${map.boardDto.fileName }" download>${map.boardDto.fileName }</a>
          </td>
        </tr>
      </table>
      <hr>
